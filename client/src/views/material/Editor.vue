...
export default {
  ...
  mounted() {
    ...
    //this.provider = new TiptapCollabProvider('ws://0.0.0.0:1234', '', ydoc )
    ...
    /*this.provider = new HocuspocusProvider({
      name: '1234567', // Unique document identifier for syncing. This is your document name.this.userData.editingId
      baseURL: 'ws://0.0.0.0:1234', // Your Cloud Dashboard AppID or `baseURL` for on-premises
